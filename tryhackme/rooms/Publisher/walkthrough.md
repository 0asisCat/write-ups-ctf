...
MAC Address: 02:5C:6B:47:F9:59 (Unknown)
No exact OS matches for host (If you know what OS is running on it, see https://nmap.org/submit/ ).
TCP/IP fingerprint:
OS:SCAN(V=7.80%E=4%D=7/30%OT=22%CT=1%CU=32895%PV=Y%DS=1%DC=D%G=Y%M=025C6B%T
OS:M=6889C39D%P=x86_64-pc-linux-gnu)SEQ(SP=107%GCD=1%ISR=10A%TI=Z%CI=Z%II=I
